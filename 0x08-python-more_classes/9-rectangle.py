...
`9-rectangle`: Contains class `Rectangle`
"""
...
class Rectangle:
    ...
    def __str__(self) -> str:
        ...
        Returns:
            str: str representation of a rectangle
            with the character in `print_symbol`
        """
        str_list = []
    ...
    def bigger_or_equal(rect_1, rect_2):  # type: ignore
        ...
        Raises:
            TypeError: _If `rect_1` or `rect_2`is not a `Rectangle` instance_
    ...
    @classmethod
    def square(cls, size=0):  # type: ignore
        """ Class method to return a square instance of `Rectangle`

        Args:
            size (int, optional): _Size of the square_. Defaults to 0.

        Returns:
            _obj_: _square `Rectangle` instance_
        """
